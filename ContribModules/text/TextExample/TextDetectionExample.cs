...
namespace OpenCVForUnityExample
{
    ...
    {
        //stores path of image file upon which text detection has to be chcked for.
        ...
        private void Run ()
        {
            ...
            //Internally Loads DLLs responsible for conversion jpg into Mat(Native Plugins in C++ will be called from c#)
